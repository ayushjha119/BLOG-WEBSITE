            ...
            <InPageNavigation routes={["Published Blogs", "Draft"]} defaultActiveIndex={activeTab != "draft" ? 0 : 1}>
                {
                   ...
                   <LoadMoreDataBtn state={blogs} fetchDataFun={getBlogs} additionalParam={{draft: false, 
...

                {
                   ...
                   <LoadMoreDataBtn state={drafts} fetchDataFun={getBlogs} additionalParam={{draft: true, 
                   deletedDocCount: drafts.deletedDocCount
                   }} />
                   </>
                    : <NoDataMessage message="No drafs Blog" />
                }
